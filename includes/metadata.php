...
wj_theme_define( 'WJ_PLUGIN_VERSION', '2.0.1' ); // The minimum version required for the Plugin to work with this theme, update on Major releases or feature additions